...
type ButtonProps<T extends solidJs.ValidComponent = "button"> =
	ButtonPrimitive.ButtonRootProps<T> &
		VariantProps<typeof buttonVariants> & {
			class?: string | undefined;
			children?: solidJs.JSX.Element;
		};

const Button = <T extends solidJs.ValidComponent = "button">(
	props: PolymorphicProps<T, ButtonProps<T>>,
) => {
	const [local, others] = splitProps(props, ["variant", "size", "class"]);
	return <ButtonPrimitive.Root class={buttonVariants(local)} {...others} />;
};
